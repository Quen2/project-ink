...
export default function ModalPostList({userId = null, searchFilter}) {
  ...
  return (
    <div className="w-full">
      <div>
        <div className="bg-[#282828] flex justify-around flex-wrap text-white w-full gap-3 overflow-y-auto border h-full">
          {posts ? (
            posts.length > 0 ? (
              posts.map((post) => (
                <Link
